...
- **Typed network action plan schema**
  ...
  - The complete action plan schema and required fields are defined canonically in `network-policy-engine-spec.md` Section 5. This document does not redefine them.
